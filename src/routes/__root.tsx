  ...
  head: () => ({
    meta: [
      ...
      { title: "Rital Events — Donnez vie à vos événements" },
      {
        name: "description",
        content:
          "Agence événementielle complète : événementiel, traiteur, logistique et organisation d'événements sur-mesure.",
      },
      { name: "author", content: "Rital Events" },
      { name: "theme-color", content: "#1E3A5F" },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Rital Events" },
